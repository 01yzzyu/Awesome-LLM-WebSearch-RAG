...
| :-----: | :------------------: | :--------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------: | :---------:| :---------: | :---------:
| 2024-10-9 | AutoFeedback | NUDT | [AutoFeedback: An LLM-based Framework for Efficient and Accurate API Request Generation](https://arxiv.org/abs/2410.06943) | Arxiv |  [Code](https://github.com/NeverMoreLCH/SearchLVLMs) | [project](https://nevermorelch.github.io/SearchLVLMs.github.io/) | [解读](https://github.com/01yzzyu/Websearch-RAG/blob/main/assets/SearchLVLMs/SearchLVLMs.md) |
...
| 2023-04-19 | ViperGPT | ColumbiaU | [ViperGPT: Visual Inference via Python Execution for Reasoning](https://arxiv.org/abs/2303.08128) | CVPR 2024 |  [Code](https://github.com/cvlab-columbia/viper) | [project](https://viper.cs.columbia.edu/) | [解读](https://github.com/01yzzyu/Websearch-RAG/blob/main/assets/SearchLVLMs/SearchLVLMs.md) |
